    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('album', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='musik.album', verbose_name='Song Album')),
            ],
            options={
                'verbose_name': 'Song',
        ...
        migrations.AddField(
            model_name='album',
            name='artist',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='musik.artist', verbose_name='Artist Album'),
        ),
    ]
